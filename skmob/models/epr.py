    ...
    **Return phase**. If the individual returns to a previously visited location, such a location :math:`i` is chosen with probability proportional to the number of time the agent visited :math:`i`, i.e., :math:`\Pi_i = f_i`, where :math:`f_i` is the visitation frequency of location :math:`i`.
    ...
    def generate(self, start_date, end_date, spatial_tessellation, gravity_singly={}, n_agents=1,
        ...
        TrajDataFrame
            the synthetic trajectories generated by the model
        """
        return super().generate(start_date, end_date, spatial_tessellation, gravity_singly=gravity_singly, n_agents=n_agents, starting_locations=starting_locations, od_matrix=od_matrix, relevance_column=relevance_column, random_state=random_state, log_file=log_file, verbose=verbose)
...
class SpatialEPR(EPR):
    ...
    **Return phase**. If the individual returns to a previously visited location, such a location :math:`i` is chosen with probability proportional to the number of time the agent visited :math:`i`, i.e., :math:`\Pi_i = f_i`, where :math:`f_i` is the visitation frequency of location :math:`i`.
    ...
    >>> end_time = pd.to_datetime('2019/01/14 08:00:00')
    >>> sepr = SpatialEPR()
    >>> tdf = sepr.generate(start_time, end_time, tessellation, n_agents=100, verbose=True)
    >>> print(tdf.head())
       uid                   datetime        lat        lng
    ...
    >>> print(tdf.parameters)
    {'model': {'class': <function SpatialEPR.__init__ at 0x7f548a49e048>, 'generate': {'start_date': Timestamp('2019-01-01 08:00:00'), 'end_date': Timestamp('2019-01-14 08:00:00'), 'gravity_singly': {}, 'n_agents': 100, 'relevance_column': None, 'random_state': None, 'verbose': True}}}    
    ...
    def generate(self, start_date, end_date, spatial_tessellation, gravity_singly={}, n_agents=1,
                 starting_locations=None, od_matrix=None, random_state=None, log_file=None, verbose=False):
        """
        Start the simulation of a set of agents at time `start_date` till time `end_date`.
        ...
        TrajDataFrame
            the synthetic trajectories generated by the model
        """
        return super().generate(start_date, end_date, spatial_tessellation, gravity_singly=gravity_singly, n_agents=n_agents, starting_locations=starting_locations, od_matrix=od_matrix, relevance_column=None, random_state=random_state, log_file=log_file, verbose=verbose)
...
class Ditras(EPR):
    ...
    **Outline of the DITRAS framework**. DITRAS combines two probabilistic models: a diary generator (e.g., :math:`MD(t)`) and trajectory generator (e.g., d-EPR). The diary generator produces a mobility diary :math:`D`. The mobility diary :math:`D` is the input of the trajectory generator together with a weighted spatial tessellation of the territory :math:`L`. From :math:`D` and :math:`L` the trajectory generator produces a synthetic mobility trajectory :math:`S`.
    ...
    {'model': {'class': <function Ditras.__init__ at 0x7f0cf0b7e158>, 'generate': {'start_date': Timestamp('2019-01-01 08:00:00'), 'end_date': Timestamp('2019-01-14 08:00:00'), 'gravity_singly': {}, 'n_agents': 3, 'relevance_column': 'population', 'random_state': None, 'verbose': True}}}
