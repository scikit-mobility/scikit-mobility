...
class TestDetection:
    ...
    def test_stops(self):
        ...
        stamps =  [pd.Timestamp('2011-02-03 09:34:04'), pd.Timestamp('2011-02-03 10:34:04'),
                   pd.Timestamp('2011-02-04 10:34:04'), pd.Timestamp('2011-02-03 09:34:04'),
                   pd.Timestamp('2011-02-04 10:34:04'), pd.Timestamp('2011-02-04 11:34:04'),
                   pd.Timestamp('2011-02-03 09:34:04'), pd.Timestamp('2011-02-04 10:34:04'),
                   pd.Timestamp('2011-02-04 11:34:04'), pd.Timestamp('2011-02-04 11:34:04'),
                   pd.Timestamp('2011-02-04 12:34:04'), pd.Timestamp('2011-02-04 11:34:04'),
                   pd.Timestamp('2011-02-05 12:34:04'), pd.Timestamp('2011-02-04 11:34:04')]
        ...
        expected = self.trjdat.drop([0,1,3,4,6,7,8,10,11,12,13,14,15,17,18,19])
